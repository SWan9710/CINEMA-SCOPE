<template>
  <div>
    ...
    <h1 style="color:white; margin-bottom:0.5em;">EDIT PROFILE</h1>
    
    <div class="edit-main" style="margin-bottom:3em;">
      <form @submit.prevent="profileUpdate" id='profileUpdateForm'>
        <div class="edit-form">
          ...
          <div class="d-flex justify-content-center flex-column" style="width:50%; margin-right:6em; margin-top:1em; border-bottom:solid white 1px;">
            <!-- 이메일 입력창 -->
            <div class="edit">
            ...
            <div class="edit">
              ...
              <input class="edit-input" type="text" placeholder="아이디를 입력하세요" id="inputId" required v-model="credentials.username" disabled><br><br>
            </div>
          </div>
        </div>
        ...
        <button class="btn btn-secondary rounded-pill" style="color:white; width:200px; margin-bottom:1.5em; margin-right:1.5em" form="profileUpdateForm" type="submit" >수정하기</button>
...
export default {
  ...
  data() {
    return {
      ...
      profile_img: '',
      imageUrl: {
        url: this.$route.params.userInfo.profile_img
      },
      ifFlag: false
    }
  },
  methods: {
    profileUpdate() {
      ...
      this.$store.dispatch('profileUpdate', this.credentials)
    },
    // 장르 데이터 받아오기
    getGenres() {
